            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section_title text-center mb-70">
                        <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" >Our Mantra</span>
                        <h3 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">We take pride in being the main source of management, booking and production of hip-hop, afro-pop, afro-soul, r&b, highlife music.
                    ...
                    <div class="work_info">
                        ...
                        <div class="video_watch d-flex align-items-center">
                            <div class="play_btn wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                                <a href="https://www.youtube.com/watch?v=CIaxb7UnOn8" class="video_icon popup-video"> <i class="fa fa-play"></i> </a>
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-90">
                        ...
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Tell us about that next big project.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
