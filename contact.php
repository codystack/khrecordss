        ...
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="phone" id="subject" type="tel" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" placeholder = 'Phone number'>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
        ...
        <div class="col-lg-4">
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3>31 Williams onoh Chevy View</h3>
              <p>Lekki Phase II</p>
            </div>
          </div>
          <div class="media contact-info">
